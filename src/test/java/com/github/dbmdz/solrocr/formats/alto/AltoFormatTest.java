...
public class AltoFormatTest {
   ...
   * Prevent regression
   * 
   * Highlighting OCR fields=[ocr_text] for query=ocr_text:china in docIDs=[173] 
   * with maxPassagesOcr=[100]
   *
   * @throws IOException
   */
  @Test
  public void testHighlightingHallischeOrientWiss01() throws Exception {
    ...
    RuntimeException rExc = assertThrows(RuntimeException.class, () -> {
